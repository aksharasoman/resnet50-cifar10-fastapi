# training/train.py
'''
Using different optimizer and scheduler (SGD)
...
def main():
    ...
    optimizer = optim.SGD(params_train, lr=0.1,
                        momentum=0.9, weight_decay=5e-4)
    scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=200)

    print('3. Training...')
    ## Call your training loop    
    train_model(model, train_loader, test_loader, criterion, optimizer, scheduler, num_epochs=200, device=device)
